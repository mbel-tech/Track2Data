...
The reference R pipeline lives at `D:\CHOICE R SCRIPTS\choice R pipeline\` on the maintainer's machine. **The output data from that pipeline is currently pre-publication embargoed and MUST NOT be committed to git.**
